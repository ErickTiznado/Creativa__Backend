...
export default class AuthController {
  ...
  static async register(req, res) {
    ...
    try {
      ...
      if (dbError) {
        ...
        res.statusCode = 500;
        return res.json({
          error: "Usuario creado, pero falló al guardar el perfil.",
        });
      }
  ...
  static async resetPassword(req, res) {
    try {
      ...
      if (
        !upperCasePattern.matches(newPassword) ||
        !digitPattern.matches(newPassword)
      ) {
        res.statusCode = 400;
        return res.json({
          error:
  ...
  static async changeUserRole(req, res) {
    try {
      ...
      if (authError) {
        ...
        res.statusCode = 500;
        return res.json({
          error: "No se pudo actualizar el rol en autenticación",
        });
      }
      ...
      if (dbError) {
        ...
        res.statusCode = 500;
        return res.json({
          error: "Rol actualizado en Auth pero falló en Perfil",
        });
      }
